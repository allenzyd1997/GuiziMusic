    			...
    			<div class="album_content">
						...
						<li class="one_album_el" v-for="item in row1">
							<div class="one_album">
								...
								<div class="album_intro">
									<a href="javascript:;" class="album_name_link"><p class="songlist_name">{{item.album_name}}</p></a>
									<a href="javascript:;" class="artist_name_link"><p class="artist_name">{{item.user_nickname}}</p></a>
					...
					<ul class="all_albums">
						<li class="one_album_el" v-for="item in row2">
							<div class="one_album">
								<a href="javascript:;" @click="random">
									<div class="outer_cover">
										<img v-bind:src="item.album_pic">
										<div class="inner_cover">
											<img src="../../common/image/play_op.png" class="inner_img">
