<template>
    ...
    <div class="m-header">
        ...
        <span class="el-dropdown-link">
            <img style="border-radius: 90px; margin-right: 5px; vertical-align: -10px" src="../../common/image/1.jpg" width="40px" height="40px" ><i class="el-icon-arrow-down el-icon--right"></i>
        </span>
