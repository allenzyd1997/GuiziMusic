<template>
    ...
    <div class="m-header">
        ...
        <el-dialog title="登陆" :visible.sync="loginVisible" center:append-to-body="true" :lock-scroll="false" width="25%" @closed="LoginVisible(false)" :before-close="handleDialogClose">
