<template>
    <div class="search">
        <div class="mod_search">
            ...
            <el-autocomplete placeholder="搜索音乐、专辑、歌单、用户" v-model="search" :fetch-suggestions="querySearchAsync" @select="handleSelect" value-key="address" width="600px" height="60px">
