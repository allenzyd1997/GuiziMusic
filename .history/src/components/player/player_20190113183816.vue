        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-center" :class="disableCls">
                <a href="javascript:;" @click="togglePlaying"><img src="../../common/image/PLAY.png" :class="playIcon"></a>
            </div>
            ...
            <div class="bg_player" style="background-image: url()">
