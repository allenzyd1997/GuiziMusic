                            ...
                            <el-table-column width="400px">
                                <template scope="scope">
                                    <div class="icon-menu" style="transform: scale(0.7)">
                                        <a href="javascript:;" title="播放" @click="selectItem(scope.row.id)">
                    ...
                    <div class="mod_song_info">
                            <div class="song_info">
                                ...
                                <div class="song_info_singer">
                                    歌手名:
                                    <a href="">{{currentSong.singer_name}}</a>
                                </div>
                                <div class="song_info_album">
                                    专辑名:
                                    <a href="">{{currentSong.album_name}}</a>
                                </div>
                            </div>
...
import {playSongList, getLyric, getSongById} from '@/axios/api'
    ...
    export default {
        ...
        if (this.currentLyric) {
          this.currentLyric.togglePlay()
            ...
            getLyric() {
                getLyric(this.currentSong.lyric).then(res => {
