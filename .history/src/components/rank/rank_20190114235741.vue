            ...
            <div class="toplist">
                ...
                <div class="songlist">
                    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" selection-change="handleSelectionChange" :row-style="setRowStyle">
                        ...
                        <el-table-column label="歌曲" width="200" prop="album.name">
                            <template scope="scope">
                                <img src="../../common/image/2.jpg" width="60px" height="60px"><span>{{tableData.album.artist.name}}</span>
                            </template>
                        </el-table-column> 
                        ...
                        <el-table-column label="歌手" width="200" prop="album.artists[0].name">

                        </el-table-column>
                        <el-table-column label="时长" width="200" prop="hMusic.playTime">
        ...
        methods: {
            ...
            getRankSong(id) {
                getRank(id).then(res => {
                    ...
                    tableData = res.data.result.tracks
                })
            }
        },
        components: {
