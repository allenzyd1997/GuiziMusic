        ...
        <div class="main">
            <div class="toplist_nav">
                ...
                <dl class="toplist_nav__list">
                    ...
                    <dd class="toplist_nav__item">
                        <a href="javascript:;" class="toplist_nav__link" @clikc="getRankSong(3778678)">Billboard周榜</a>
                    </dd>      
                    <dd class="toplist_nav__item">
                        <a href="javascript:;" class="toplist_nav__link" @click="getRankSong(3778678)">iTunes榜</a>
                    </dd>                                                                                              
                </dl>
            </div>  
            <div class="toplist">
