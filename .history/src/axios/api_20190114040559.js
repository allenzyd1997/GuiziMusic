...
export const listSingerByFirstName = params => {
    console.log('/api/artistinfo/firsthanzicode_page?firsthanzicode='+params.firstName+'&currentPage='+params.page+'&pageSize='+params.size)
    return axios.get('/api/artistinfo/firsthanzicode_page?firsthanzicode='+params.firstName+'&currentPage='+params.page+'&pageSize='+params.size)
}
