...
export const createSonglist = params => {
    return axios.post('/api/songlist/addSonglist?songlist_id='+params.songlist_id+'&user_id='+params.user_id+'&songlist_name='+params.songlist_name+'&songlist_time='+params.songlist_time)
}
